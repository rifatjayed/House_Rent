        ...
        <section>
            <div className='container mx-auto min-h-[800px] mb-14'>
                ...
                <div className='flex flex-col items-start gap-8 lg:flex-row'>
                    ...
                    <div className='flex-1 bg-white-100 w-full mb-8 border border-gray-300 rounded-lg px-6 py-6'>
                        ...
                        <form className='flex flex-col gap-y-4'>
                            ...
                            <textarea className='border border-gray-300 focus:border-violet-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400' placeholder='Massage'></textarea>
                            <div className='flex gap-x-2'>
                                <button className='bg-violet-700 hover:bg-violet-800 text-white rounded p-4 text-sm w-full transition'>Send Massage</button>
